...
public class Alumno implements Modificable<Alumno>,Serializable, Comparable<Alumno>{
	...
	public Alumno(String nombre, String dni, Integer edad, String ciclo, Integer curso) {
		super();
		this.nombre = nombre;
		this.dni = dni;
		this.edad = edad;
	...
	public Alumno (String nombre, String dni, Integer edad, String ciclo, Integer curso, ArrayList<Integer> matriculadoEn) {
		super();
		this.nombre = nombre;
		this.dni = dni;
		this.edad = edad;
