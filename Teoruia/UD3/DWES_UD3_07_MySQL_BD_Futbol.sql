...
CREATE  TABLE IF NOT EXISTS `ciudades` (
  ...
  `habitantes` INT(11) NULL DEFAULT NULL ,
  PRIMARY KEY (`id`) )
ENGINE = InnoDB
...
CREATE  TABLE IF NOT EXISTS `porteros` (
  ...
  `partidos` INT(11) NULL DEFAULT NULL ,
  `goles` INT(11) NULL DEFAULT NULL ,
  PRIMARY KEY (`idEquipo`, `dorsal`) ,
...
CREATE  TABLE IF NOT EXISTS `goleadores` (
  ...
  `partidos` INT(11) NULL DEFAULT NULL ,
  `goles` INT(11) NULL DEFAULT NULL ,
  `penaltis` INT(11) NULL DEFAULT NULL ,
  `pp` INT(11) NULL DEFAULT NULL ,
  `minutosGol` INT(11) NULL DEFAULT NULL ,
  `gTtitular` INT(11) NULL DEFAULT NULL ,
  `gSuplente` INT(11) NULL DEFAULT NULL ,
  `gPuntos` INT(11) NULL DEFAULT NULL ,
  `gVictoria` INT(11) NULL DEFAULT NULL ,
  `gRemontada` INT(11) NULL DEFAULT NULL ,
...
CREATE  TABLE IF NOT EXISTS `partidos` (
  `idEquipoL` VARCHAR(3) NOT NULL DEFAULT '' ,
  `idEquipoV` VARCHAR(3) NOT NULL DEFAULT '' ,
  `jornada` INT(11) NOT NULL ,
  `golesL` INT(11) NULL DEFAULT NULL ,
  `golesV` INT(11) NULL DEFAULT NULL ,
  `posesionL` INT(11) NULL DEFAULT NULL ,
  PRIMARY KEY (`idEquipoL`, `idEquipoV`) ,
  INDEX `idEquipoV` (`idEquipoV` ASC) ,
  INDEX `partidos_ibkf_3` (`jornada` ASC) ,
...
GRANT ALL on futbol.* TO 'futbol'@'localhost'; 
-- GRANT ALL on futbol.* TO 'futbol'@'%'; 
-- ---------------------------------------------------
-- DATOS
-- ---------------------------------------------------
